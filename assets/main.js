(function() {
    ...
    window.openWhatsapp = function() {
        var subDomain = isMobileBrowser() ? 'api' : 'web';
        window.open('https://'+subDomain+'.whatsapp.com/send?phone=+972543013513&text='+encodeURIComponent('היי, ביקרתי אצלך באתר, ואני מעוניין/ת בצילומים. תצרי איתי קשר בבקשה, תודה'));
    };
